...
Vì sao cần file này?
--------------------
Đo trung bình trên 2.000 ca mô phỏng không trả lời được câu hỏi:
...
Nhãn "đáp án đúng" chỉ có giá trị khi có tờ giấy có
...
def da_duyet_hop_le():
    ...
    định sai trước người dùng. Hàm này chặn đúng trường hợp đó.
    """
    if not BS_DA_KY:
        return False
