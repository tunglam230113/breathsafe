...
if ten_trang == "Sàng lọc":
    ...
    # Cho phép nạp sẵn một ca kinh điển để demo nhanh.
...
# ---------------------------------------------------------------------------
# Vì sao cần trang này? Vì có một mục là đối
...
# ---------------------------------------------------------------------------
    ...
    if not lich_su:
        ...
        st.caption(
            "Cột này trả lời một câu thường gặp: trong thực tế, bao nhiêu "
...
# ---------------------------------------------------------------------------
    ...
    # ĐÚNG mô hình app đang dùng, nên người dùng bấm một nút là thấy bằng chứng
